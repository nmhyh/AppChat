...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void register(final String username, String email, String password, final String phone, final String age, final String sex){
    ...
    public void btn_register(View view) {
        ...
        if(TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)
                || TextUtils.isEmpty(txt_age) || TextUtils.isEmpty(txt_phone) || TextUtils.isEmpty(txt_confirm_password)){
            ...
            register(txt_username, txt_email,txt_password, txt_phone, txt_age, txt_sex);
        }
    }
}